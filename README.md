...
Please see our [arXiv paper](linktoarxivpaper) for a more detailed overview of the challenge.
...
The baseline solution is described in the [Intel N-DNS Challenge paper](linktoarxivpaper). 
...
Please refer to the [Intel N-DNS Challenge paper](linktoarxivpaper) for more details about the metrics.
